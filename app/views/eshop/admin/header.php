...
<html lang="en">
  <head>
    ...
    <!--[if lt IE 9]>
      <script src="<?=ASSETS . THEME?>https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script>
      <script src="<?=ASSETS . THEME?>https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script>
    <![endif]-->
  </head>
      ...
      <header class="header black-bg">
            ...
            <div class="nav notify-row" id="top_menu">
                ...
                <ul class="nav top-menu">
                    <!-- settings start -->
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="<?=ROOT?>index#">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="<?=ROOT?>index#">See all messages</a>
                            </li>
                        </ul>
                    </li>
                    <!-- inbox dropdown end -->
